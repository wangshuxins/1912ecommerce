...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/index/static/css/pages-seckill-index.css" />
</head>
...
<script>
	...
	<div class="py-container index">
		<!--banner-->
		<div class="banner">
			<img src="/index/static/img/_/banner.png" class="img-responsive" alt="">
		</div>
		<!--秒杀时间-->
		<div class="sectime">
		...
		<div class="goods-list">
			<ul class="seckill" id="seckill">
				<li class="seckill-item">
					<div class="pic">
						<img src="/index/static/img/_/list.jpg" alt=''>
					</div>
					...
					<a class='sui-btn btn-block btn-buy' href='{{url("/shop/seckillitem")}}' target='_blank'>立即抢购</a>
				</li>
				<li class="seckill-item">
					<div class="pic">
						<img src="/index/static/img/_/list.jpg" alt=''>
