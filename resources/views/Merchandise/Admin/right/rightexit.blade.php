...
@section('content')
                ...
                <div class="tab-content">
                    ...
                    <form encrype="multipart/from-data">
                        <div class="col-md-10 data">
                            <input type="hidden" class="form-control" id="hidden" right_id="{{$right->right_id}}">
                        </div>
                        <div class="tab-pane active" id="home">
                            <div class="row data-type">
                                <div class="col-md-2 title">权限名称</div>
                                <div class="col-md-10 data">
                                    <input type="text" class="form-control" name="right_name" placeholder="权限名称" value="{{$right->right_name}}"  >
                                </div>

                                <div class="col-md-2 title">权限url</div>
                                <div class="col-md-10 data">
                                    <input type="text" class="form-control" name="right_url"  placeholder="权限url" value="{{$right->right_url}}" >
                                </div>
                                <div class="col-md-2 title editer">权限描述</div>
                                <div class="col-md-10 data editer">
                                    <textarea name="right_desc" id="content" >{{$right->right_desc}}</textarea>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script type="text/javascript">
        ...
        $("#submit").click(function(){
            var right_id = $("#hidden").attr('right_id');
